...
export default function TallerCorte() {
  ...
  return (
    <div className="container-fluid" style={{ padding: '2rem', color: 'var(--text-color)' }}>
      {/* Encabezado Principal */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h1 style={{ fontSize: '2rem', margin: 0, display: 'flex', alignItems: 'center', gap: '10px', fontWeight: 'bold' }}>
            <Scissors size={28} color="#0ea5e9" /> 
            {isEn ? 'Cutting Room Control' : 'Control del Taller de Corte'}
          </h1>
          <p className="text-muted" style={{ margin: '5px 0 0 0', fontSize: '0.9rem' }}>
            {isEn ? 'Productivity, attendance and cost-per-piece metrics' : 'Métricas de productividad, asistencia y costo unitario de corte'}
          </p>
        </div>
        ...
        <div className="glass-card" style={{ display: 'flex', padding: '4px', gap: '4px' }}>
          ...
          >
            ...
            {isEn ? 'Weekly Cost Report' : 'Reporte de Costos'}
          </button>
          <button 
      ...
      {/* --- PESTAÑA 2: REPORTE DE RENDIMIENTO Y COSTOS --- */}
      {activeTab === 'reporte' && (
        <div className="row">
          {/* Filtros de Reporte */}
          <div className="col-md-12 mb-4">
            ...
            <div className="glass-card" style={{ padding: '1.5rem', overflowX: 'auto' }}>
              ...
              <table className="data-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                ...
                <tbody>
                  ...
                  {/* Fila: Costo Promedio Corte Proyectado */}
                  ...
                  {/* --- SECCION: PROCESO FUSIONADO REAL --- */}
      ...
      {/* --- PESTAÑA 3: CATALOGO DE PERSONAL --- */}
      {activeTab === 'personal' && (
        <div className="row">
