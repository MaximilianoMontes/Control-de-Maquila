...
export default function Reportes() {
  ...
  return (
    <div>
      <h1 className="gradient-text" style={{ marginBottom: '2rem' }}>{t('rep.title')}</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '3rem 2rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>{t('rep.invTitle')}</h2>
          <p style={{ color: '#94a3b8', marginBottom: '1.5rem' }}>{t('rep.invDesc')}</p>
          
          <div style={{ width: '100%', marginBottom: '2rem', textAlign: 'left' }}>
            <label className="form-label">{t('inv.statusFilter')}</label>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '3rem 2rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>{t('rep.recMerc')}</h2>
          <p style={{ color: '#94a3b8', marginBottom: '1.5rem' }}>{t('rep.recDesc2')}</p>
          
          <div style={{ width: '100%', marginBottom: '1rem', textAlign: 'left' }}>
            <label className="form-label">{t('rep.recDate')}</label>
            ...
            <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <label htmlFor="showRange" style={{ fontSize: '0.85rem', color: '#64748b', cursor: 'pointer' }}>{t('rep.recRange')}</label>
            </div>

            {endDate !== '' && (
              <div style={{ marginTop: '1rem' }}>
                <label className="form-label">{t('rep.recUntil')}</label>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '3rem 2rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>{t('rep.payTitle')}</h2>
          <p style={{ color: '#94a3b8', marginBottom: '1.5rem' }}>{t('rep.payDesc')}</p>
