...
const getEmptyForm = () => ({ numero: '', modelo: '', precio: '', cliente: '', no_orden: '', variantes: [{ color: '', cantidad: '' }], imagenUrl: '', observaciones: '', precio_plancha: '' });
...
export default function Cortes() {
  ...
  const openReprogram = (item, e) => {
    ...
    setFormData({
      ...
      precio_plancha: item.precio_plancha || '',
    });
    setImagenFile(null);
    setIsModalOpen(true);
  };
